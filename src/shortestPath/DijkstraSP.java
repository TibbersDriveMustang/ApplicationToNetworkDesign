...
public class DijkstraSP {
    ...
    public DijkstraSP(Graph graph, String initialVertexLabel){
        this.graph = graph;
        ...
        this.availableVertices = new PriorityQueue<Vertex>(vertexKeys.size(), new Comparator<Vertex>(){
            ...
            public int compare(Vertex one, Vertex two){
                int weightOne = DijkstraSP.this.distances.get(one.getLabel());
                int weightTwo = DijkstraSP.this.distances.get(two.getLabel());
...
/*    
    public static void main(String[] args){
        ...
        DijkstraSP dijkstra = new DijkstraSP(graph, vertices[0].getLabel());
